...
<video controls muted style="width:100%;height:100%;margin-left:auto;margin-right:auto;object-fit:cover">
    <source src="drag-drop-python.webm" type="video/webm">
    <source src="drag-drop-python.mp4" type="video/mp4">
...
<p>
<video controls muted style="width:100%;height:100%;margin-left:auto;margin-right:auto;object-fit:cover">
    <source src="gallery_dl_start.webm" type="video/webm">
    <source src="gallery_dl_start.mp4" type="video/mp4">
    Your browser does not support the playing these videos.
</video></p>
